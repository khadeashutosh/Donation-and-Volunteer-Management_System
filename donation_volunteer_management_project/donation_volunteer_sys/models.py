...
class Donor(models.Model):
    ...
    def __str__(self):
        return self.user.username  # returns string
...
class DonationArea(models.Model):
    ...
    def __str__(self):
        return self.areaname if self.areaname else "Unnamed Area"
...
class Donation(models.Model):
    ...
    def __str__(self):
        # Use donationname or fallback to ID
        return f"{self.donationname or 'Donation'} (ID: {self.id})"
...
class Gallery(models.Model):
    ...
    def __str__(self):
        ...
        return f"Gallery for {self.donation.donationname or 'Donation'} (ID: {self.donation.id})"
