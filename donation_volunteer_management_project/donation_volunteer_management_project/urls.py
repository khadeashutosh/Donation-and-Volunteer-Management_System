...
from donation_volunteer_sys import views
from django.conf import settings
from django.conf.urls.static import static
from django.contrib.auth import views as auth_views
from donation_volunteer_sys.forms import MyPasswordResetForm,MySetPasswordForm
...
urlpatterns = [
    ...
    path("view-volunteerdetail/<int:pid>",
        views.view_volunteerdetail.as_view(),
        name="view_volunteerdetail",
    ),
    path("view-donordetail/<int:pid>", 
         views.view_donordetail, 
         name="view_donordetail"),
    path(
